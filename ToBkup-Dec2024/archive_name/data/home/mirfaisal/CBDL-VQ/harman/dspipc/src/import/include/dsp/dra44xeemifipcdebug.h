 ...
 */
#define FNUM_DRA44XEEMIFIPC_C 1
 ...
 */
struct _DSPIPCDra44xeFileNames {
        /**
    * @brief File number
    *
 ...
 */
typedef struct _DSPIPCDra44xeFileNames DSPIPCDra44xeFileNames;
 ...
 * an assert was taken
 */
DSPIPCDra44xeFileNames DSPIPCdra44xeFileNameArray[] = {
        { FNUM_DRA44XEEMIFIPC_C, "DRA44XEEMIFIPC.c" },
        { 0, NULL }
};
