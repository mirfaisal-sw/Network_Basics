...
static struct force_error_test_item test_vector[] = {
	...
	{"ecc 0x10",			1, REBOOT_REASON_PANIC},
};
...
static int exynos_debug_test_remove(struct platform_device *pdev)
{
	debugfs_remove(exynos_debug_desc.debugfs_root);
	return 0;
}
...
static struct platform_driver exynos_debug_test_driver = {
	...
	.remove		= exynos_debug_test_remove,
	.driver		= {
