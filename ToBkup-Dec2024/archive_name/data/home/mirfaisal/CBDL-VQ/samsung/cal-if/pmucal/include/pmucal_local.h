...
struct pmucal_local_variant {
	struct pmucal_pd *p_pmucal_pd_list;
	unsigned int *p_pmucal_pd_list_size;
};

#define PMUCAL_PD_DESC_V9(_pd_id, _name, _on, _save, _off, _status)	\
	[_pd_id] = {							\
		.id = _pd_id,						\
		.name = _name,						\
		.cmu_init = NULL,					\
...
extern struct pmucal_pd pmucal_pd_list_v9[];
extern unsigned int pmucal_pd_list_size_v9;

extern struct pmucal_pd pmucal_pd_list_v920_evt0[];
extern unsigned int pmucal_pd_list_size_v920_evt0;

extern struct pmucal_pd pmucal_pd_list_v620_evt0[];
extern unsigned int pmucal_pd_list_size_v620_evt0;

extern struct pmucal_pd pmucal_pd_list[];
extern unsigned int pmucal_pd_list_size;

extern struct pmucal_local_variant *pmucal_local_variant_model;
extern struct pmucal_local_variant pmucal_local_variant_v9;
extern struct pmucal_local_variant pmucal_local_variant_v920_evt0;
extern struct pmucal_local_variant pmucal_local_variant_v920_evt2;
extern struct pmucal_local_variant pmucal_local_variant_v620_evt0;
#endif
