...
/*
 * Common Clock Framework support for exynosautov920_evt2 SoC.
 *
 * Copyright (c) 2022 Samsung Electronics Co., Ltd.
 *        http://www.samsung.com/
 */

#include "clkout_exynosautov920_evt2.h"
...
struct cmucal_clkout v920_evt2_cmucal_clkout_list[] = {
};

unsigned int v920_evt2_cmucal_clkout_size;
