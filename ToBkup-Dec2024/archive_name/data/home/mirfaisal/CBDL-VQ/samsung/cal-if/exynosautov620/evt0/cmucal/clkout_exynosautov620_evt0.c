...
/*
 * Common Clock Framework support for exynosautov620_evt0 SoC.
 *
 * Copyright (c) 2023 Samsung Electronics Co., Ltd.
 *        http://www.samsung.com/
 */

#include "clkout_exynosautov620_evt0.h"
...
struct cmucal_clkout v620_evt0_cmucal_clkout_list[] = {
};

unsigned int v620_evt0_cmucal_clkout_size;
