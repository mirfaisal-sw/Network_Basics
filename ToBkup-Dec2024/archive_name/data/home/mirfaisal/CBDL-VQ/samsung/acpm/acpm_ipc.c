...
/*
 * Samsung ExynosAuto SoC series ACPM IPC driver
 *
 * exynosauto acpm ipc functions
 *
...
#if defined(CONFIG_EXYNOS_RGT) && defined(CONFIG_DEBUG_SNAPSHOT)
...
EXPORT_SYMBOL_GPL(acpm_ipc_set_waiting_mode);
...
* @prdcode
* @unit_name{acpm_ipc}
* @purpose request proper ACPM IPC Channel Information
* @logic 1. Reads the values provided in DT\n
* 2. find proper ACPM IPC Channel\n
* 3. add to cb list channel list when the handler is not null
* @params
* @param{in, np, struct ::device_node, -}
* @param{in, handler, ipc_callback, -}
* @param{in, id, unsigned int *, -}
* @param{in, size, unsigned int *, -}
* @endparam
* @retval{-, unsigned int, 0, -2^31 ~ 0, !0}
*/
...
* @prdcode
* @unit_name{acpm_ipc}
* @purpose release the ACPM IPC Channel
* @logic erase channel from cb list
* @params
* @param{in, np, struct ::device_node, -}
* @param{in, channel_id, unsigned int, <=10}
* @endparam
...
* @prdcode
* @unit_name{acpm_ipc}
* @purpose to Get the response message from APM
* @logic 1. dequeue IPC message from buffer\n
* 2. copy the message to input arg
* @params
* @param{out, channel->list, struct ::list_head, -}
* @param{out, channel->rx_lock, spinlock_t, -}
* @param{out, channel->rx_ch, struct * ::acpm_ipc_ch, -}
* @param{out, channel->cmd, unsigned int *, -}
* @param{in, channel->id, unsigned int, >= 0}
* @param{out, cfg->cmd, unsigned int *, -}
* @endparam
* @retval{ret, bool, true, true or false, false}
*/
...
* @prdcode
* @unit_name{acpm_ipc}
* @purpose Generates an interrupt to the APM
* @logic Write value to SFR for Interrupt Generation
* @params
* @param{in, id, unsigned int, 0~16}
* @endparam
* @noret
*/
...
* @prdcode
* @unit_name{acpm_ipc}
* @purpose Write data to APM SRAM
* @logic 1. IPC Channel Buffer full check\n
* 2. Write data at ACPM IPC Channel\n
* 3. Receive a response message if necessary
* @params
* @param{in, channel_id, unsigned int, <=10}
* @param{in, cfg->response, bool, true or false}
* @param{out, cfg->cmd, unsigned int *, -}
* @endparam
* @retval{-, int, 0, -2^31 ~ (2^31 - 1), !0}
*/
		...
		while (!(__raw_readl(acpm_ipc->intr + INTSR1) & (1 << channel->id)) ||
			...
			if (timeout < now) {
				if (retry_cnt > 5) {
					...
					pr_err("acpm_ipc timeout retry %d now = %llu, timeout = %llu\n",
...
* @prdcode
* @unit_name{acpm_ipc}
* @purpose To Gets The ACPM IPC channel information from the APM SRAM
* @logic Get the ACPM IPC Information from APM SRAM
* @noparam
* @retval{0, int, -, -2^31 ~ (2^31 - 1), !0}
*/
...
* @prdcode
* @unit_name{acpm_ipc}
* @purpose To Get ACPM IPC Information from APM SRAM
* @logic 1. Gets the platform device pointer\n
* 2. Reads the values provided in DT\n
* 3. ACPM IPC Channel initialize
* @params
* @param{in, pdev, struct platform_device*, not null}
* @param{in, pdev->name, const char* , not null}
* @param{in, pdev->id, int, not null}
* @param{in, pdev->dev, u32, not null}
* @param{in, pdev->numresources, u32, not null}
* @param{in, pdev->resources, struct resources*, not null}
* @param{in, id_entry, const struct platform_device_id*, not null}
* @param{in, driver_override, char*, not null}
* @param{in, mfd_cell, struct mfd_cell*, not null}
* @param{in, archdata, struct pdev_archdata, not null}
* @param{out, pdev, struct platform_device, not null}
* @endparam
* @retval{0, int, 0, 0 or 1, 1}
*/
