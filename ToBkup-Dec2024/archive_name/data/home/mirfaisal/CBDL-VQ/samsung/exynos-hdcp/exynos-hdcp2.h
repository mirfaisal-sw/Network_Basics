...
#define MAX_NUM_OF_HDCP			2
#define MAX_NUM_OF_STRM			4
...
#define HDCP_MSG_READ_WAIT		200
#define HDCP_HPRIME_READ_RETRY		10
#define HDCP_HPRIME_TIMEOUT_NOKM	1000
#define HDCP_HPRIME_TIMEOUT_STKM	200
...
enum auth_state {
	HDCP_AUTH_PROCESS_INIT  = 0x0,
	HDCP_AUTH_PROCESS_IDLE  = 0x1,
	HDCP_AUTH_PROCESS_RUN	= 0x2,
	HDCP_AUTH_PROCESS_STOP  = 0x3,
	HDCP_AUTH_PROCESS_DONE  = 0x4
};
