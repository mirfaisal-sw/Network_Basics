...
int ake_generate_masterkey(uint32_t node, uint32_t lk_type,
		uint8_t *enc_mkey, size_t elen);
int ake_make_hmac(uint32_t node, uint8_t *whmac, uint8_t *wrap_mkey,
		uint8_t *rtx, uint8_t repeater,
		uint8_t *hmac_append);
int ake_make_hmac_with_caps(uint32_t node, uint8_t *whmac, uint8_t *wrap_mkey,
...
int ske_generate_riv(uint32_t node, uint8_t *out, uint8_t *typ);
int ske_generate_sessionkey(uint32_t node, uint32_t lk_type, uint8_t *enc_skey,
		int share_skey);
