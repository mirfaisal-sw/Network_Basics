...
#define SMC_HDCP_INIT			(0x82004010u)
#define SMC_HDCP_TERMINATE		(0x82004011u)
#define SMC_HDCP_PROT_MSG		(0x82004012u)
#define SMC_CHECK_STREAM_TYPE_FLAG	(0x82004022u)
#define SMC_HDCP_NOTIFY_INTR_NUM	(0x82004023u)

#define SMC_DRM_HDCP_AUTH_INFO		(0x82002140u)
#define SMC_DRM_HDCP_FUNC_TEST		(0x82002141u)
#define SMC_DRM_DP_CONNECT_INFO		(0x82002142u)
...
int teei_generate_master_key(uint32_t node, uint32_t lk_type,
		uint8_t *emkey, size_t emkey_len);
int teei_compare_ake_hmac(uint32_t node, uint8_t *hmac, size_t hamc_len);
...
int teei_gen_lc_hmac(uint32_t node, uint32_t lk_type, uint8_t *lsb128_hmac);
...
int teei_generate_skey(uint32_t node, uint32_t lk_type,
		...
		int share_skey);
int teei_encrypt_packet(uint32_t node, uint8_t *input, size_t input_len,
